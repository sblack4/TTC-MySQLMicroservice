...
let httpCode=`curl -i -X GET \
 ...
 -sL -w "%{http_code}" \
  https://${PAAS_HOST}/paas/api/v1.1/instancemgmt/${ID_DOMAIN}/services/MySQLCS/instances/MicroserviceDB \
  -o /dev/null`
...
https://${PAAS_HOST}/paas/api/v1.1/instancemgmt/${ID_DOMAIN}/services/MySQLCS/instances/MicroserviceDB/accessrules
